class App extends React.Component{
    constructor(props){
        ...
        selections: {name: ['blank'],
                        brand: ['blank'], 
                        /*Removing color as a selector for now, but might add it back later*/
                        /*color: ['blank'], */
    ...
    formatIngredients = (dBase) => {
        ...
        tempDatabase.forEach(tea => {
            ...
            //single taste entries come through as a string and break the li mapping function above, this makes them an array
    ...
    buildSelections = () => {
        ...
        let newElement = (
            <div id={'r-sel-' + ki} key={'sel-' + ki} onClick={this.selectionsClick} className='selections-button'>
                {ki}
                <div id={'sel-options-' + ki} key={'sel-options-' + ki} className='options-space'>
                    {optionButtons}
                </div>
            </div>    
        );
    ...
    clearSelections = () => {
        ...
        clearButton.style.background = '#bf0000';
        setTimeout(() => {
            clearButton.style.background = originalBackground;
        }, 100);
    }
    ...
    render(){
        ...
        /*big ugly svg element below. ends @ line 570-ish*/
